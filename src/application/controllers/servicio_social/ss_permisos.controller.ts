...
export class SsPermisosController {
  ...
  */
  ...
  async ObtenerTodos() {
    return this.obtenerSsPermisosUseCase
      .ObtenerTodos();
  }
  ...
  */
  ...
  @ApiResponse({
    status: 200,
    description: 'Permiso encontrado correctamente',
  })
  ...
  */
  ...
  @ApiOperation({
    summary: 'Obtener permisos por nombre',
  })

  @ApiParam({
    name: 'permiso',
    type: String,
    description: 'Nombre del permiso a buscar',
  })

  @ApiResponse({
    status: 200,
    description: 'Permisos encontrados correctamente',
  })
  ...
  @ApiResponse({
    status: 404,
    description: 'No se encontraron permisos con ese nombre',
  })
  ...
  async ObtenerPorNombrePermiso(
    ...
    return this.obtenerSsPermisosUseCase
      .ObtenerPorNombrePermiso(permiso);
  }
  ...
  */
  ...
  async Crear(
    @Body()
    dto: CrearSsPermisosDto,
  ) {
    return this.crearSsPermisosUseCase
      .Ejecutar(dto);
  }
  ...
  */
  ...
  async Eliminar(
    ...
    await this.eliminarSsPermisosUseCase
      .Ejecutar(id);
  ...
  */
  ...
  @ApiResponse({
    status: 409,
    description: 'Conflicto: Ya existe un permiso con ese nombre',
  })
  ...
  async Actualizar(
    ...
    return this.actualizarSsPermisosUseCase
      .Ejecutar(id, dto);
  }
